  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/foto.jpg" class="rounded-circle " alt="User Image">
        </div>
        <div class="info">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h1 class="text-bold text-center text-primary">SELAMAT DATANG !</h1>
              </div>
              <div class="card-body">
                <br>
                <h5>Website ini berisi kumpulan hasil praktikum mata kuliah pemrograman web 2 semester 2 dari praktikum 1 - 6</5>.
                <br>
              </div>
            </div>
